...
<?if ( count( $arResult["ITEMS"] ) ):?>
	<div class="product-section">
		<div class="section-title"><?=GetMessage("CS_RELATED_HEADER");?></div>
		...
		<div class="read-more-link-wrapp">
			<a href="/catalog/related/<?=$arParams["TARGET_ID"]?>/" class="read-more-link">
				<span><?=GetMessage("CS_RELATED_ALL");?></span>
