...
<a href="#" onclick="$('#city-modal').arcticmodal();" class="chooseRepresent c-black linkRedHover linkDotted keepDotted showMoreRepresent">
	<span class="linkDotted header-city">
		<?=$arResult[ "LOCATION" ] ? $arResult[ "LOCATION" ] : "Город"?>
	</span>
</a>
<?$this->EndViewTarget();?>
